...
_G.packer_plugins = {
  ...
  ["papercolor-theme-slim"] = {
    loaded = true,
    path = "/home/artem/.local/share/nvim/site/pack/packer/start/papercolor-theme-slim",
  ...
  ["telescope-file-browser.nvim"] = {
    loaded = true,
    path = "/home/artem/.local/share/nvim/site/pack/packer/start/telescope-file-browser.nvim",
