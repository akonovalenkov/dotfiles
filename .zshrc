...
plugins=(git z vi-mode colored-man-pages ripgrep)
...
#
#export NPM_CONFIG_REGISTRY=http://npm-registry.spotify.net
#export NPM_CONFIG_USERCONFIG=~/.spmrc
...
export PATH="/home/artem/anaconda2/bin:$PATH"
